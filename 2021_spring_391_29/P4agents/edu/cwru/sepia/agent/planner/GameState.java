...
//        System.out.println("action: " + stripsActionStack.peek().toString());
    ...
    public GameState(State.StateView state, int playernum, int requiredGold, int requiredWood, boolean buildPeasants) {
        ...
        for (int id : state.getUnitIds(playernum)) {
            if (state.getUnit(id).getTemplateView().getName().equalsIgnoreCase("townhall")) {
                ...
                this.peasant = new Peasant(new Position(state.getUnit(id).getXPosition(), state.getUnit(id).getYPosition()), false, 0);
            }
        }
     ...
     */
    public GameState(GameState parent, Peasant peasant, HashMap<Integer, MyResourceView> resources, Stack<StripsAction> stripsActionStack) {
        this.parent = parent;
        this.peasant = peasant;
        this.resources = new HashMap<>(resources);
        this.stripsActionStack = stripsActionStack;

        double costFromParentToNow = peasant.position.euclideanDistance(parent.peasant.position);
    ...
    public static class Peasant {
        ...
        public Peasant(Position position, boolean isCarrying, int amountCarrying) {
            this.position = position;
    ...
    public List<GameState> generateChildren() {
        ...
        possibleStripsAction.add(new Deposit(townhallUnitView.getXPosition(), townhallUnitView.getYPosition(), townhallUnitView.getID()));
...
//        return requiredGold / 100 * nearestGoldMineDistance + requiredWood / 100  * nearestForestDistance;
        return requiredWood + requiredGold;
    }
